...
const AuthorizeLocation = () => {
    return (
        <div className="w-screen h-screen absolute top-0 left-0 bg-white flex flex-col items-center justify-center p-6 overflow-hidden">
            ...
            <Button className="mt-24 text-base">Access location</Button>
            <span className="text-[#646982] text-base uppercase text-center mt-9">goodfood will access your location only while using the app</span>
        </div>
    )
}
